window.onload = function() {
    ...
    {
    	phone = phones.create(game.rnd.integerInRange(100,500), game.rnd.integerInRange(700), 'phone');
    	phone = phones.create(game.rnd.integerInRange(600,1000), game.rnd.integerInRange(700), 'phone');
    	phone = phones.create(game.rnd.integerInRange(1100,1500), game.rnd.integerInRange(700), 'phone');
    	phone = phones.create(game.rnd.integerInRange(1600,2000), game.rnd.integerInRange(700), 'phone');
    }
